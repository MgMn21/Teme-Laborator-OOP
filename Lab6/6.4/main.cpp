...
class Operatii {
    ...
    public:
        ...
        static double Sum(double real_1, double real_2);
        static double Subtraction(double real_1, double real_2);
        static double Multiply(double real_1, double real_2);
        static double Divide(double real_1, double real_2);

        static NumarComplex Sum(NumarComplex &comp_1, NumarComplex &comp_2);
        static NumarComplex Subtraction(NumarComplex &comp_1, NumarComplex &comp_2);
        static NumarComplex Multiply(NumarComplex &comp_1, NumarComplex &comp_2);
        static NumarComplex Divide(NumarComplex &comp_1, NumarComplex &comp_2);
